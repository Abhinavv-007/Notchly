...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "in.abhnv.notchly.NotchlyXPCHelper"
    
    private var remoteService: RemoteXPCService<NotchlyXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<NotchlyXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<NotchlyXPCHelperProtocol>(
            connection: conn,
            remoteInterface: NotchlyXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<NotchlyXPCHelperProtocol>? {
        remoteService
    }
